...
FIRST_PROG_REPEAT = 4
SECOND_CHORDS_PROGRESSION = ["Am3", "Dm3", "Am3", "Dm3"] + ["F2", "G2", "C3", "E3"]
...
if __name__ == "__main__":
    ...
    first_prog_freqs = get_progression_freqs(FIRST_CHORDS_PROGRESSION)
    logging.info("First freq progression: \n %s" % (str(first_prog_freqs)))
    second_prog_freqs = get_progression_freqs(SECOND_CHORDS_PROGRESSION)
